...
class AI85ESC20Netv34(nn.Module):
    """
    Compound ESC20 v3 Audio net, all with Conv1Ds
    """
    ...
    def forward(self, x):  # pylint: disable=arguments-differ
        ...
        return x
class AI85ESC20Netv35(nn.Module):
    """
    Compound ESC20 v3 Audio net, all with Conv1Ds
    """
    ...
    def __init__(
        ...
        self.drop = nn.Dropout(p=0.2)
        # Time: 128 Feature :128
        self.voice_conv1 = ai8x.FusedConv1dReLU(num_channels, 256, 1, stride=1, padding=0,
                                                bias=bias, **kwargs)
        # T: 128 F: 100
        self.voice_conv2 = ai8x.FusedConv1dReLU(256, 256, 3, stride=1, padding=0,
                                                bias=bias, **kwargs)
        # T: 126 F : 96
        self.voice_conv3 = ai8x.FusedMaxPoolConv1dReLU(256, 128, 3, stride=1, padding=1,
                                                       bias=bias, **kwargs)
        # T: 62 F : 64
        self.voice_conv4 = ai8x.FusedConv1dReLU(128, 64, 3, stride=1, padding=0,
                                                bias=bias, **kwargs)
        # T : 60 F : 48
        self.esc_conv1 = ai8x.FusedMaxPoolConv1dReLU(64, 64, 3, stride=1, padding=1,
                                                     bias=bias, **kwargs)
...
class AI85ESC20Netv36(nn.Module):
    """
    Compound ESC20 v3 Audio net, all with Conv1Ds
    """
    ...
    def __init__(
        ...
        self.voice_conv2 = ai8x.FusedConv1dReLU(128, 128, 3, stride=1, padding=0,
                                                bias=bias, **kwargs)
        # T: 126 F : 96
        self.voice_conv3 = ai8x.FusedMaxPoolConv1dReLU(128, 128, 3, stride=1, padding=1,
                                                       bias=bias, **kwargs)
        # T: 62 F : 64
        self.voice_conv4 = ai8x.FusedConv1dReLU(128, 128, 3, stride=1, padding=0,
                                                bias=bias, **kwargs)
        # T : 60 F : 48
        self.esc_conv1 = ai8x.FusedMaxPoolConv1dReLU(128, 128, 3, stride=1, padding=1,
                                                     bias=bias, **kwargs)
        # T: 30 F : 64
        self.esc_conv2 = ai8x.FusedConv1dReLU(128, 128, 3, stride=1, padding=0,
                                              bias=bias, **kwargs)
        # T: 28 F : 96
        self.esc_conv3 = ai8x.FusedAvgPoolConv1dReLU(128, 128, 3, stride=1, padding=1,
                                                     bias=bias, **kwargs)
        # T : 14 F: 100
        self.esc_conv4 = ai8x.FusedMaxPoolConv1dReLU(128, 64, 6, stride=1, padding=1,
                                                     bias=bias, **kwargs)
        # T : 2 F: 128
        self.fc = ai8x.Linear(256, num_classes, bias=bias, wide=True, **kwargs)
...
class AI85ESC20Netv37(nn.Module):
    """
    Compound ESC20 v3 Audio net, all with Conv1Ds
    """
...
class AI85ESC20Netv38(nn.Module):
    """
    Compound ESC20 v3 Audio net, all with Conv1Ds
    """
    ...
    def __init__(
        ...
        self.voice_conv2 = ai8x.FusedConv1dReLU(256, 256, 3, stride=1, padding=0,
                                                bias=bias, **kwargs)
                # T: 128 F: 100
        self.voice_conv21 = ai8x.FusedConv1dReLU(256, 256, 3, stride=1, padding=0,
                                                bias=bias, **kwargs)
        # T: 126 F : 96
        self.voice_conv3 = ai8x.FusedMaxPoolConv1dReLU(256, 256, 3, stride=1, padding=1,
                                                       bias=bias, **kwargs)
        # T: 62 F : 64
        self.voice_conv4 = ai8x.FusedConv1dReLU(256, 256, 3, stride=1, padding=0,
                                                bias=bias, **kwargs)
        # T : 60 F : 48
        self.esc_conv1 = ai8x.FusedMaxPoolConv1dReLU(256, 128, 3, stride=1, padding=1,
                                                     bias=bias, **kwargs)
        # T: 30 F : 64
        self.esc_conv2 = ai8x.FusedConv1dReLU(128, 128, 3, stride=1, padding=0,
                                              bias=bias, **kwargs)
...
class AI85KWS20Net00(nn.Module):
    """
...
def ai85esc20netv3(pretrained=False, **kwargs):
    ...
    #return AI85ESC20Netv34(**kwargs)
    #return AI85ESC20Netv35(**kwargs)
    #return AI85ESC20Netv36(**kwargs)
    #return AI85ESC20Netv37(**kwargs)
    #return AI85ESC20Netv38(**kwargs)
    return AI85KWS20Net00(**kwargs)
