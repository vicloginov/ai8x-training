                    ...
                    for n_a, audio_seq in enumerate(audio_seq_list):
                        ...
                        for n_r in range(num_rows):
                            ...
                            data_in[data_idx, :, n_r] = \
                                ESC.quantize_audio(audio_chunk,
...
def ESC_get_datasets(data, load_train=True, load_test=True, num_classes=6):
    """
    Load the dataset
...
def ESC_20_get_datasets(data, load_train=True, load_test=True):
    """
    ...
    0.8 and 1.3, -0.1 and 0.1, 0 and 1, respectively.
    """
    return ESC_get_datasets(data, load_train, load_test, num_classes=20)
